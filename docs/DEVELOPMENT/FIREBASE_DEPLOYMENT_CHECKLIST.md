...
- [ ] Share [Firebase Hosting Setup Guide](../TECHNICAL/FIREBASE_HOSTING_SETUP.md) with team
...
- [Firebase Hosting Setup Guide](../TECHNICAL/FIREBASE_HOSTING_SETUP.md)
...
For questions, see the [Firebase Hosting Setup Guide](../TECHNICAL/FIREBASE_HOSTING_SETUP.md) or [CI/CD Documentation](./CI_CD_SETUP.md).
